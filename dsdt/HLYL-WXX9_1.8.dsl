 ...
 *
 * Disassembly of dsdt.dat, Thu Feb  3 14:18:32 2022
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000903F (36927)
...
DefinitionBlock ("", "DSDT", 1, "HUAWEI", "EDK2    ", 0x00000002)
{
    ...
    Method (STMP, 1, NotSerialized)
    {
        Name (BUFF, Buffer (0x0100) {})
        Local0 = Arg0
        CreateByteField (Arg0, 0x02, STSN)
        CreateByteField (Arg0, 0x03, STSM)
        CreateByteField (Arg0, 0x04, STSS)
        CreateByteField (Arg0, 0x05, STT1)
        CreateByteField (Arg0, 0x06, STT2)
        CreateByteField (BUFF, Zero, STAT)
        STAT = One
        If (((STSS == Zero) && (STT2 == Zero)))
        {
            If ((STSN == Zero))
            {
                If ((STSM == One))
    ...
    Method (STUB, 1, NotSerialized)
    {
        ...
        If ((TUBM == One))
        {
            If ((\_SB.PCI0.LPC0.EC0.ACDC == One))
            {
                \_SB.PCI0.LPC0.EC0.TUBO = One
                \_SB.WMI1.WMEN = 0x02A1
        ...
        ElseIf ((TUBM == Zero))
        {
            If ((\_SB.PCI0.LPC0.EC0.ACDC == One))
            {
                \_SB.PCI0.LPC0.EC0.TUBO = Zero
                \_SB.WMI1.WMEN = 0x02A0
                Notify (\_SB.WMI1, 0xA0) // Device-Specific
            }
        }
        Else
    ...
    Method (SKBT, 1, NotSerialized)
    {
        ...
        \_SB.PCI0.LPC0.EC0.KBBL = Local3
        \_SB.PCI0.LPC0.EC0.KBBH = Local4
    ...
    Method (GBAI, 1, Serialized)
    {
        ...
        CreateByteField (BUFF, Zero, STAT)
        CreateByteField (BUFF, One, BYIL)
        CreateByteField (BUFF, 0x02, BYIH)
        CreateField (BUFF, 0x08, 0x08, BY01)
        CreateField (BUFF, 0x08, 0x10, BY02)
        CreateField (BUFF, 0x08, 0x20, BY03)
        CreateField (BUFF, 0x08, 0x30, BY04)
        CreateField (BUFF, 0x08, 0x40, BY05)
        CreateField (BUFF, 0x08, 0x78, BY06)
        CreateField (BUFF, 0x08, 0x80, BY07)
        CreateField (BUFF, 0x08, 0x98, BY08)
        CreateField (BUFF, 0x08, 0x0100, BY09)
        STAT = Zero
        Switch (ToInteger (RNUM))
        {
            Case (One)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.CHCU
            }
            Case (0x03)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.BTST
            }
            Case (0x04)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.MFDT
            }
            Case (0x05)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.BTSN
            }
            Case (0x06)
            {
                BY06 = \_SB.PCI0.LPC0.EC0.BDNA
            }
            Case (0x07)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.BCL4
            }
            Case (0x08)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.BCL3
            }
            Case (0x09)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.BCL2
            }
            Case (0x0A)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.BCL1
            }
            Case (0x0B)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.SOHL
            }
            Case (0x0C)
            {
                BY04 = \_SB.PCI0.LPC0.EC0.SFST
            }
            Case (0x0D)
            {
                BY04 = \_SB.PCI0.LPC0.EC0.PFSS
            }
            Case (0x0E)
            {
                BY04 = \_SB.PCI0.LPC0.EC0.OPSS
            }
            Case (0x0F)
            {
                BY03 = \_SB.PCI0.LPC0.EC0.CHGS
            }
            Case (0x10)
            {
                BY09 = \_SB.PCI0.LPC0.EC0.LDB1
            }
            Case (0x11)
            {
                BY05 = \_SB.PCI0.LPC0.EC0.LDB2
            }
            Case (0x12)
            {
                BY07 = \_SB.PCI0.LPC0.EC0.LDB3
            }
            Case (0x13)
            {
                BY09 = \_SB.PCI0.LPC0.EC0.LDB4
            }
            Case (0x14)
            {
                BY09 = \_SB.PCI0.LPC0.EC0.LDB5
            }
            Case (0x15)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.BT1T
            }
            Case (0x16)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.BTCC
            }
            Case (0x17)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.BT1C
            }
            Case (0x19)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.BT1V
            }
            Case (0x1A)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.BTFC
            }
            Case (0x1D)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.IIIT
            }
            Case (0x1E)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.FCCR
            }
            Case (0x1F)
            {
                BY02 = \_SB.PCI0.LPC0.EC0.CHGV
            }
            Case (0x21)
            {
                BY01 = \_SB.PCI0.LPC0.EC0.BSOC
            }
            Case (0x22)
            {
                BY01 = \_SB.PCI0.LPC0.EC0.RSOC
            }
            Case (0x23)
            {
                BY01 = \_SB.PCI0.LPC0.EC0.RSOC
    ...
    Method (SBAC, 1, Serialized)
    {
        ...
        Local0 = Arg0
        CreateByteField (BUFF, Zero, STAT)
        CreateByteField (Arg0, 0x02, SBAS)
        STAT = Zero
        Switch (ToInteger (SBAS))
        {
            Case (One)
            {
                \_SB.PCI0.LPC0.EC0.BACF = One
            }
            Case (0x02)
            {
                \_SB.PCI0.LPC0.EC0.BACF = Zero
            }
            Default
            {
                STAT = One
    ...
    Method (GBAC, 1, NotSerialized)
    {
        Name (BUFF, Buffer (0x0100) {})
        Local0 = Arg0
        CreateByteField (BUFF, Zero, STAT)
        CreateByteField (BUFF, One, BADS)
        BADS = \_SB.PCI0.LPC0.EC0.BACF
        STAT = Zero
    ...
    Method (GAIT, 1, NotSerialized)
    {
        ...
        Local0 = Arg0
        CreateByteField (BUFF, Zero, STAT)
        CreateByteField (BUFF, One, ACTL)
        CreateByteField (BUFF, 0x02, ACTH)
        ACTL = \_SB.PCI0.LPC0.EC0.ALD9
        ACTH = \_SB.PCI0.LPC0.EC0.ALD8
        STAT = Zero
    ...
    OperationRegion (GNVS, SystemMemory, 0xCDF5FA98, 0x00000189)
    ...
    OperationRegion (OGNS, SystemMemory, 0xCDF5FD18, 0x0000000C)
    ...
    Scope (_SB)
    {
        ...
        Device (PCI0)
        {
            ...
            Device (LPC0)
            {
                ...
                Device (EC0)
                {
                    ...
                    OperationRegion (WRAM, SystemMemory, 0xFEDD8200, 0x0100)
                    Field (WRAM, ByteAcc, Lock, Preserve)
                    {
                        LDB1,   256, 
                        LDB4,   256, 
                        LDB5,   256, 
                    ...
                    OperationRegion (CRAM, SystemMemory, 0xFEDD8C00, 0x0100)
        ...
        Device (BAT1)
        {
            ...
            Method (UPBX, 0, NotSerialized)
            {
                ...
                BXMN = ^^PCI0.LPC0.EC0.BDNA /* \_SB_.PCI0.LPC0.EC0_.BDNA */
                PBFE (BXMN, ^^PCI0.LPC0.EC0.BDBC, Zero)
                ...
                BXOI = ^^PCI0.LPC0.EC0.BNAM /* \_SB_.PCI0.LPC0.EC0_.BNAM */
                PBFE (BXOI, ^^PCI0.LPC0.EC0.BNBC, Zero)
            ...
            Method (UPBI, 0, NotSerialized)
            {
                ...
                BFMN = ^^PCI0.LPC0.EC0.BDNA /* \_SB_.PCI0.LPC0.EC0_.BDNA */
                PBFE (BFMN, ^^PCI0.LPC0.EC0.BDBC, Zero)
                ...
                BFOI = ^^PCI0.LPC0.EC0.BNAM /* \_SB_.PCI0.LPC0.EC0_.BNAM */
                PBFE (BFOI, ^^PCI0.LPC0.EC0.BNBC, Zero)
