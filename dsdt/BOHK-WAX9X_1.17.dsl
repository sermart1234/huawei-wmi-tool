 ...
 *
 * Disassembly of dsdt.dat, Fri Feb 11 23:52:14 2022
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00009B44 (39748)
...
DefinitionBlock ("", "DSDT", 1, "HUAWEI", "EDK2    ", 0x00000002)
{
    ...
    Method (GAIT, 1, NotSerialized)
    {
        ...
        ACTL = \_SB.PCI0.LPC0.EC0.APTL
        ACTH = \_SB.PCI0.LPC0.EC0.APTH
        STAT = Zero
    ...
    OperationRegion (MDBG, SystemMemory, 0xAF35D018, 0x00001004)
        ...
        Device (PCI0)
        {
            ...
            Device (LPC0)
            {
                ...
                Device (EC0)
                {
                    ...
                    OperationRegion (DRAM, SystemMemory, 0xFF708200, 0x0100)
                    Field (DRAM, ByteAcc, Lock, Preserve)
                    {
                        LDB1,   256, 
                        LDB4,   256, 
                        LDB5,   256, 
    ...
    Scope (_SB.I2CD)
    {
        Device (TPDG)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                Return (RBUF) /* \_SB_.I2CD.TPDG._CRS.RBUF */
            }
