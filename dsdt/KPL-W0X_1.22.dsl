 ...
 *
 * Disassembly of dsdt.dat, Tue Nov 17 10:57:27 2020
 *
 ...
 *     Checksum         0xC3
 *     OEM ID           "HUAWEI"
 *     OEM Table ID     "Tambouri"
 *     OEM Revision     0x00040000 (262144)
 *     Compiler ID      "ACPI"
 *     Compiler Version 0x00040000 (262144)
 */
DefinitionBlock ("", "DSDT", 1, "HUAWEI", "Tambouri", 0x00040000)
{
    /*
            ...
            If ((ODVN <= 0x05))
            {
                Switch (ToInteger (ODVN))
                {
                    Case (Zero)
                    {
                        If ((ACIR == 0x02))
                        {
                            \_SB.PCI0.LPC0.EC0.SPMD = One
                        }
                        Else
                        {
                            \_SB.PCI0.LPC0.EC0.SPMD = Zero
                        }
    ...
    OperationRegion (GNVS, SystemMemory, 0x8F7BBA98, 0x00000186)
    ...
    OperationRegion (OGNS, SystemMemory, 0x8F7A0E98, 0x0000000B)
    ...
    OperationRegion (MDBG, SystemMemory, 0x8F399018, 0x00001004)
        ...
        Device (PCI0)
        {
            ...
            Device (LPC0)
            {
                ...
                Device (EC0)
                {
                    ...
                    Method (_QA6, 0, Serialized)  // _Qxx: EC Query, xx=0x00-0xFF
                    {
